...
\begin{figure}[t]
\centering{}\subfloat{\includegraphics[scale=0.5]{2C__Users_Hao_Dropbox_NewtermPHD_TERM2_SS9833B____of_brain_imaging_data_Report_MANOVA_PCA_Sig.png}}
\subfloat{\includegraphics[scale=0.5]{3C__Users_Hao_Dropbox_NewtermPHD_TERM2_SS9833B_____brain_imaging_data_Report_MANOVA_PCA_Power.png}}\protect\caption{{\footnotesize{}CV-MANOVA using the first $N$ principal components
...
\begin{figure}[ht]
\centering{}\includegraphics[scale=0.5]{4C__Users_Hao_Dropbox_NewtermPHD_TERM2_SS9833B____in_imaging_data_Report_MANOVA_PCA_Variation.png}\
...
\begin{figure}[t]
\begin{centering}
\subfloat{\includegraphics[scale=0.5]{5C__Users_Hao_Dropbox_NewtermPHD_TERM2_SS9833B_____imaging_data_Report_MANOVA_dist_regressor1.png}}\
\subfloat{\includegraphics[scale=0.5]{6C__Users_Hao_Dropbox_NewtermPHD_TERM2_SS9833B_____imaging_data_Report_MANOVA_dist_regressor3.png}}
\par\end{centering}
...
\begin{figure}[t]
\begin{centering}
\subfloat{\includegraphics[scale=0.5]{9C__Users_Hao_Dropbox_NewtermPHD_TERM2_SS9833B____maging_data_Report_CVMANOVA_dist_regressor1.png}}
\subfloat{\includegraphics[scale=0.5]{10C__Users_Hao_Dropbox_NewtermPHD_TERM2_SS9833B___maging_data_Report_CVMANOVA_dist_regressor3.png}}
\par\end{centering}
...
\subsubsection{Noise Tolerance of MANOVA and CVMANOVA}
